...
if __name__ == '__main__':
    ...
    # Save to JSON (original code)
    with open('dummy_training_data/bicycle_sentence_similarities.json', 'w') as f:
        json.dump(pairs, f, indent=2)

    # New: Save to CSV
    with open('dummy_training_data/sentence_similarities_guitar.csv', 'w', newline='', encoding='utf-8') as f:
        writer = csv.DictWriter(f, fieldnames=["sentence1", "sentence2", "similarity"])
        writer.writeheader()
